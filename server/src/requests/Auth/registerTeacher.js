...
exports.registerTeacher = () => {
    const messages = customValidation.teacher
    ...
    return [
        ...
        body('bio')
            .notEmpty().withMessage(messages.bio.required),
        body('yearsExperience')
            .notEmpty().withMessage(messages.yeardExperience.required)
            .isInt().withMessage(messages.yeardExperience.mustBeInteger)
    ];
};